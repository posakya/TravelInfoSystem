...
public class Brj_AC extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new JSONTask().execute("http://192.168.137.1/busreservation/SapanaTravel/traveldetailBrjAC.php");
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.btn_click.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(getActivity(), PassengerBrjAC.class));
                }
            });
            return convertView;
        }
