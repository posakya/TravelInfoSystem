...
public class KTMA_C extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new JSONTask().execute(Constants.BASE_URL +"/BusReservation/SapanaTravel/traveldetailKTMAC.php");
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.btn_click.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(getActivity(), PassengerKTMAC.class));
                }
            });
            return convertView;
        }
